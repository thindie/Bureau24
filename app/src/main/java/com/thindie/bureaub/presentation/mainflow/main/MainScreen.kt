        ...
        Column(
            ...
            BurButton(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(all = 16.dp),
                onClick = { it.onUserFlowEvent(MainFlowEvent.BureauUserSurfFlow) },
                title = "\"Surf\" User Flow"
            )
            BurButton(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(all = 16.dp),
                onClick = { it.onUserFlowEvent(MainFlowEvent.TagsUserFlow) },
                title = "\"Tags\" User Flow"
            )
